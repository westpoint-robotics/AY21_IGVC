...
def reactToPerson(): #once done, copy this into reactToPothole
    ...
    #    targetVelocity = -1.0
    #was 340
    if 320 < personYcor and personXcor < 400 and personXcor > 800: #(personXcor/45-600/45)**2/4 +300 < personYcor:
...
def reactToBarrelTwo():
    ...
    #was 340
    # was 370
    if 300< personYcor:#barrelYcor: #(personXcor/45-600/45)**2/4 +300 < personYcor:
        #print "First Barrel within range"
        if barrelDone and 410 < barrelYcor:
            print "second barrel"
            targetVelocity = -1.0
        #targetVelocity = -1.0
        personDetected = True    
